...
if __name__ == "__main__":
    ...
    # Tek bir DataFrame'e dönüştür ve kaydet
    sonuc_df = pd.DataFrame(tüm_sonuçlar)
    sonuc_df.to_csv("word2vec_stemmed_tum_sonuclar.csv", index=False, encoding="utf-8-sig")
    print("✅ Tüm sonuçlar kaydedildi: word2vec_stemmed_tum_sonuclar.csv")
